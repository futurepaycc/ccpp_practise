/* GCC: clang++ fib1.cpp -o fib1 `llvm-config --cxxflags --ldflags --system-libs --libs core` */

/* 来源: https://github.com/llvm/llvm-project/blob/master/llvm/examples/Fibonacci/fibonacci.cpp */
#include <algorithm>
#include <cstdlib>
#include <memory>
#include <string>
...
static Function *CreateFibFunction(Module *M, LLVMContext &Context) {
    ...
    Function *FibF = Function::Create(FibFTy, Function::ExternalLinkage, "fib", M);
