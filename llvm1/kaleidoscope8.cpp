/* GCC: clang++ kaleidoscope8.cpp -o kaleidoscope8 `llvm-config --cxxflags --ldflags --system-libs --libs core` */

/* 来源: https://github.com/llvm/llvm-project/blob/master/llvm/examples/Kaleidoscope/Chapter8/toy.cpp 
   教程第8章，不含jit部分
*/
